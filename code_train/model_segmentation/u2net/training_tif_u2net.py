...
def create_seq_augment():
    ...
    seq = iaa.Sometimes(0.7, iaa.SomeOf((1,6),[
        iaa.Fliplr(0.5),
...
#     Augmen = Augmentations()
    ...
    my_model = Model_U2Net(512, 8)
    # my_model = Model_UNet3plus(480, 3)
    # my_model = Adalsn(480, 3)
    my_model.load_weights(r'/home/skymap/data/Bahrain_change/Improve_model/train/w/u2net_512_s1_16_5.h5')
    ...
    data_train = glob.glob('/home/skymap/data/Bahrain_change/LAM LAI/DATA_OTHER_V2/train/image/*.tif')
    data_val = glob.glob('/home/skymap/data/Bahrain_change/LAM LAI/DATA_OTHER_V2/val/image/*.tif')
    ...
    TRAIN_LOGDIR = '/home/skymap/data/Bahrain_change/LAM LAI/TRAIN/LOG'
    TRAIN_EPOCHS = 70
    best_val_loss = 7
    ...
    for epoch in range(TRAIN_EPOCHS):
        ...
        with tqdm(total=len_val,desc=f'Val',postfix=dict,mininterval=0.3) as pbar:
            ...
            if best_val_loss>=total_val/len_val:
                my_model.save_weights(os.path.join("/home/skymap/data/Bahrain_change/LAM LAI/TRAIN/WEIGHT", f"u2net_512_other_new_wceloss_V1_ok_{epoch}.h5"))
