...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', default='change_multi_3class_v_datacu_adamw_v1', type=str)
    ...
    # model
    # /home/skymap/data/Newmodel_cd/ChangeFormer/pre_train/pretrained_changeformer.pt
