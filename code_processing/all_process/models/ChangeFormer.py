...
class EncoderTransformer_v3(nn.Module):
    def __init__(self, img_size=256, patch_size=3, in_chans=4, num_classes=4, embed_dims=[32, 64, 128, 256],
...
class ChangeFormerV6(nn.Module):
    ...
    def __init__(self, input_nc=4, output_nc=4, decoder_softmax=False, embed_dim=256):
        ...
        self.output_nc = output_nc
        self.Tenc_x2    = EncoderTransformer_v3(img_size=256, patch_size = 7, in_chans=input_nc, num_classes=self.output_nc, embed_dims=self.embed_dims,
